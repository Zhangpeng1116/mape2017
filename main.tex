...
We studied in total of 6 XPD configurations in the investigated channels, which are $\text{XPD}_{Z,V}$, $XPD_{Z,H}$, ..., as presented in Fig. \ref{fig:3}, categoried in two postures.
